...
1.  ##### Prerequisites
    ...
    Install [Git](https://git-scm.com/downloads/) (included in Xcode), [NodeJs](https://nodejs.org/en/blog/release/v6.11.3/), [PostgreSQL](https://www.postgresql.org), [PostgreSQL](https://www.postgresql.org/download/) and (temporarily) [Python 3.6](https://www.python.org/downloads/release/python-366/) manually.

    Install [Python 3.6](https://www.python.org), [VirtualEnv](https://virtualenv.pypa.io/) and [VirtualEnvWrapper](http://virtualenvwrapper.readthedocs.org/) with Brew and Pip3
    ...
    Install Install [Git](https://git-scm.com/downloads/), [NodeJs](https://nodejs.org/en/blog/release/v6.11.3/), [PostgreSQL](https://www.postgresql.org/download/) and [Python 3.6.6](https://www.python.org/downloads/release/python-366/) manually.
