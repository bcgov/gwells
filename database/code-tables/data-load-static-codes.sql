...
\copy screen_intake_method_code (create_user,create_date,update_user,update_date,screen_intake_method_guid,screen_intake_code,description,status_flag,is_hidden,display_order) from 'screen_intake_method_code.csv' with header delimiter ',' CSV ;

--SCREEN TYPE
\echo '... loading screen_type_code code table'
\copy screen_type_code (create_user,create_date,update_user,update_date,screen_type_guid,screen_type_code,description,is_hidden,display_order) from 'screen_type_code.csv' with header delimiter ',' CSV ;


--SCREEN MATERIAL
\echo '... loading screen_material_code code table'
\copy screen_material_code (create_user,create_date,update_user,update_date,screen_material_guid,screen_material_code,description,is_hidden,display_order) from 'screen_material_code.csv' with header delimiter ',' CSV ;

--SCREEN OPENING
\echo '... loading screen_opening_code code table'
\copy screen_opening_code (create_user,create_date,update_user,update_date,screen_opening_guid,screen_opening_code,description,is_hidden,display_order) from 'screen_opening_code.csv' with header delimiter ',' CSV ;

--SCREEN BOTTOM
\echo '... loading screen_bottom_code code table'
\copy screen_bottom_code (create_user,create_date,update_user,update_date,screen_bottom_guid,screen_bottom_code,description,is_hidden,display_order) from 'screen_bottom_code.csv' with header delimiter ',' CSV ;

--SCREEN ASSEMBLY
\echo '... loading screen_assembly_type_code code table'
\copy screen_assembly_type_code (create_user,create_date,update_user,update_date,screen_assembly_type_guid,screen_assembly_type_code,description,is_hidden,display_order) from 'screen_assembly_type_code.csv' with header delimiter ',' CSV ;

--DEVELOPMENT METHOD
\echo '... loading development_method_code code table'
\copy development_method_code (create_user,create_date,update_user,update_date,development_method_guid,development_method_code,description,is_hidden,display_order ) from 'development_method_code.csv' with header delimiter ',' CSV ;

--ESTIMATION METHOD
\echo '... loading yield_estimation_method_code code table'
\copy yield_estimation_method_code (create_user,create_date,update_user,update_date,yield_estimation_method_guid,yield_estimation_method_code,description,is_hidden,display_order) from 'yield_estimation_method_code.csv' with header delimiter ',' CSV ;

--CASING MATERIAL
\echo '... loading casing_material_code code table'
\copy casing_material_code (create_user,create_date,update_user,update_date,casing_material_guid,casing_material_code,description,is_hidden,display_order ) from 'casing_material_code.csv' with header delimiter ',' CSV ;

--SURFACE SEAL METHOD
\echo '... loading surface_seal_method_code code table'
\copy surface_seal_method_code (create_user,create_date,update_user,update_date,surface_seal_method_guid,surface_seal_method_code,description,is_hidden,display_order ) from 'surface_seal_method_code.csv' with header delimiter ',' CSV ;

--SURFACE SEAL MATERIAL
\echo '... loading surface_seal_material_code table'
\copy surface_seal_material_code (create_user,create_date,update_user,update_date,surface_seal_material_guid,surface_seal_material_code,description,is_hidden,display_order ) from 'surface_seal_material_code.csv' with header delimiter ',' CSV ;

--LINER MATERIAL
\echo '... loading liner_material_code code table'
\copy liner_material_code (create_user,create_date,update_user,update_date,liner_material_guid,liner_material_code,description,is_hidden,display_order) from 'liner_material_code.csv' with header delimiter ',' CSV ;
