...
TRUNCATE TABLE gwells_well,gwells_intended_water_use,gwells_well_class,
  gwells_province_state,gwells_drilling_method,gwells_decommission_method,
  ...
  gwells_yield_estimation_method,gwells_screen_assembly_type,gwells_development_method,
