...
oc rsync /Users/garywong/projects/registry-gwells-export  $podname:/tmp
oc exec ${podname} -n moe-gwells-dev -- /bin/bash -c 'cp --remove-destination /tmp/registry-gwells-export/*.sanitized.csv  /opt/app-root/src/database/code-tables/registries/'
