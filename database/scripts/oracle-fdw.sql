...
-- sh-4.2$ psql -d gwells -U userGN0 
...
wget https://raw.githubusercontent.com/bcgov/gwells/master/database/code-tables/gwells_intended_water_use.csv -O - -q | psql -X -c "COPY gwells_intended_water_use FROM STDIN HEADER DELIMITER ',' CSV" gwells

wget https://raw.githubusercontent.com/bcgov/gwells/master/database/code-tables/gwells_well_class.csv -O - -q | psql -X -c "COPY gwells_well_class FROM STDIN HEADER DELIMITER ',' CSV" gwells

wget https://raw.githubusercontent.com/bcgov/gwells/master/database/code-tables/gwells_well_subclass.csv -O - -q | psql -X -c "COPY gwells_well_subclass FROM STDIN HEADER DELIMITER ',' CSV" gwells

wget https://raw.githubusercontent.com/bcgov/gwells/master/database/code-tables/gwells_province_state.csv -O - -q | psql -X -c "COPY gwells_province_state FROM STDIN HEADER DELIMITER ',' CSV" gwells

wget https://raw.githubusercontent.com/bcgov/gwells/master/database/code-tables/gwells_well_yield_unit.csv -O - -q | psql -X -c "COPY gwells_well_yield_unit FROM STDIN HEADER DELIMITER ',' CSV" gwells

wget https://raw.githubusercontent.com/bcgov/gwells/master/database/code-tables/gwells_drilling_method.csv -O - -q | psql -X -c "COPY gwells_drilling_method FROM STDIN HEADER DELIMITER ',' CSV" gwells

wget https://raw.githubusercontent.com/bcgov/gwells/master/database/code-tables/gwells_ground_elevation_method.csv -O - -q | psql -X -c "COPY gwells_ground_elevation_method FROM STDIN HEADER DELIMITER ',' CSV" gwells

-- sh-4.2$ psql -d gwells -U userGN0 


INSERT INTO gwells_land_district (land_district_guid,code,name,sort_order,when_created,when_updated,who_created,who_updated) 
SELECT 
