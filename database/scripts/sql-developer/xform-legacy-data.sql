...
WELL_OWNERS
WELLS_LEGAL_LAND_DIST_CODES
WELLS_DRILLER_CODES
WELLS_BCGS_NUMBERS
WELLS_CONSTR_METHOD_CODES
WELLS_AQUIFER_LITHOLOGY_CODES
WELLS_BCGS_NUMBERS
GW_CLOSURE_METHOD_CODES
GW_DRILLING_METHOD_CODES
GW_DEVELOPMENT_METHOD_CDS
GW_UTM_ZONE_CODES
WELLS_WATERSHED_CODES
WELLS_YIELD_UNIT_CODES

SPOOL OFF

===
/* Working on well_drilled_depth from total_depth_drilled */

SELECT WELLS.WELLS_WELLS.WELL_ID AS ID,
  ...
  WELLS.WELLS_WELLS.DEPTH_WELL_DRILLED,
  ...
  WELLS.WELLS_WELLS.YIELD_UNIT_CODE,
  WELLS.WELLS_YIELD_UNIT_CODES.YIELD_UNIT_DESCRIPTION,
