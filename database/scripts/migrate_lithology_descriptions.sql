...
FROM wells.wells_lithology_descriptions wld INNER JOIN wells.wells_wells w ON w.well_id=wld.well_id
...
WHERE w.acceptance_status_code NOT IN ('PENDING', 'REJECTED', 'NEW') AND
      (lithology_description_id != 257638 AND w.well_id != 54374)  AND
      (lithology_description_id != 252021 AND w.well_id != 55879)  AND
      (lithology_description_id != 239976 AND w.well_id != 8622)   AND
      (lithology_description_id != 67414  AND w.well_id != 59726 )  AND
      (lithology_description_id != 67415  AND w.well_id != 59726 )  AND
      (lithology_description_id != 67090  AND w.well_id != 21728 )  AND
      (lithology_description_id != 67119  AND w.well_id != 21732 )  AND
      (lithology_description_id != 628025 AND w.well_id != 113892) AND
      (lithology_description_id != 628026 AND w.well_id != 113892) AND
      (lithology_description_id != 628027 AND w.well_id != 113893) AND
      (lithology_description_id != 628028 AND w.well_id != 113894) AND
      (lithology_description_id != 628029 AND w.well_id != 113895) AND
      (lithology_description_id != 631336 AND w.well_id != 114455);
