...
drop table gwells_survey                            cascade;
drop table intended_water_use_code                  cascade;
drop table lithology_description_code               cascade;
drop table lithology_material_code                  cascade;
drop table registries_application                   cascade;
drop table registries_application_status            cascade;
drop table screen                                   cascade;
drop table screen_bottom_code                       cascade;
drop table screen_material_code                     cascade;
drop table well_class_code                          cascade;
drop table xform_registries_action_tracking_driller cascade;
drop table xform_registries_drillers_reg            cascade;
drop table yield_estimation_method_code             cascade;
