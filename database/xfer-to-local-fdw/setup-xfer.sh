...
psql -d wells -U wells << EOF
DROP TABLE IF EXISTS public.gw_aquifer_attrs               CASCADE;
DROP TABLE IF EXISTS public.gw_aquifer_attrs_old           CASCADE;
DROP TABLE IF EXISTS public.gw_aquifer_wells               CASCADE;
DROP TABLE IF EXISTS public.gw_casing_material_codes       CASCADE;
DROP TABLE IF EXISTS public.gw_class_of_well_codes         CASCADE;
DROP TABLE IF EXISTS public.gw_class_subclass_xrefs        CASCADE;
DROP TABLE IF EXISTS public.gw_closure_method_codes        CASCADE;
DROP TABLE IF EXISTS public.gw_development_method_cds      CASCADE;
DROP TABLE IF EXISTS public.gw_drilling_method_codes       CASCADE;
DROP TABLE IF EXISTS public.gw_filter_pack_material_cds    CASCADE;
DROP TABLE IF EXISTS public.gw_filter_pack_size_codes      CASCADE;
DROP TABLE IF EXISTS public.gw_ground_elevaton_mthd_cds    CASCADE;
DROP TABLE IF EXISTS public.gw_liner_material_codes        CASCADE;
DROP TABLE IF EXISTS public.gw_nts_mapsheets               CASCADE;
DROP TABLE IF EXISTS public.gw_orientation_of_well_cds     CASCADE;
DROP TABLE IF EXISTS public.gw_province_state_codes        CASCADE;
DROP TABLE IF EXISTS public.gw_relative_hardness_codes     CASCADE;
DROP TABLE IF EXISTS public.gw_screen_assembly_type_cds    CASCADE;
DROP TABLE IF EXISTS public.gw_screen_bottom_codes         CASCADE;
DROP TABLE IF EXISTS public.gw_screen_intake_codes         CASCADE;
DROP TABLE IF EXISTS public.gw_screen_material_codes       CASCADE;
DROP TABLE IF EXISTS public.gw_screen_opening_codes        CASCADE;
DROP TABLE IF EXISTS public.gw_screen_type_codes           CASCADE;
DROP TABLE IF EXISTS public.gw_status_of_well_codes        CASCADE;
DROP TABLE IF EXISTS public.gw_subclass_of_well_codes      CASCADE;
DROP TABLE IF EXISTS public.gw_surface_seal_materil_cds    CASCADE;
DROP TABLE IF EXISTS public.gw_surface_seal_method_cds     CASCADE;
DROP TABLE IF EXISTS public.gw_utm_zone_codes              CASCADE;
DROP TABLE IF EXISTS public.gw_water_qual_chrctrstc_cds    CASCADE;
DROP TABLE IF EXISTS public.gw_well_water_quality_xrefs    CASCADE;
DROP TABLE IF EXISTS public.gw_yield_estimated_mthd_cds    CASCADE;
DROP TABLE IF EXISTS public.wells_acceptance_status_code   CASCADE;
DROP TABLE IF EXISTS public.wells_aquifer_lithology_codes  CASCADE;
DROP TABLE IF EXISTS public.wells_aquifer_subtype_codes    CASCADE;
DROP TABLE IF EXISTS public.wells_bcgs_numbers             CASCADE;
DROP TABLE IF EXISTS public.wells_casings                  CASCADE;
DROP TABLE IF EXISTS public.wells_constant                 CASCADE;
DROP TABLE IF EXISTS public.wells_constr_method_codes      CASCADE;
DROP TABLE IF EXISTS public.wells_driller_codes            CASCADE;
DROP TABLE IF EXISTS public.wells_errors                   CASCADE;
DROP TABLE IF EXISTS public.wells_ground_water_authrzation CASCADE;
DROP TABLE IF EXISTS public.wells_legal_land_dist_codes    CASCADE;
DROP TABLE IF EXISTS public.wells_lith_description_codes   CASCADE;
DROP TABLE IF EXISTS public.wells_lithology_colour_codes   CASCADE;
DROP TABLE IF EXISTS public.wells_lithology_descriptions   CASCADE;
DROP TABLE IF EXISTS public.wells_lithology_material_codes CASCADE;
DROP TABLE IF EXISTS public.wells_location_accuracy_code   CASCADE;
DROP TABLE IF EXISTS public.wells_owners                   CASCADE;
DROP TABLE IF EXISTS public.wells_perforations             CASCADE;
DROP TABLE IF EXISTS public.wells_production_data          CASCADE;
DROP TABLE IF EXISTS public.wells_screens                  CASCADE;
DROP TABLE IF EXISTS public.wells_sequences                CASCADE;
DROP TABLE IF EXISTS public.wells_temp_access              CASCADE;
DROP TABLE IF EXISTS public.wells_temp_access_lithology    CASCADE;
DROP TABLE IF EXISTS public.wells_use_codes                CASCADE;
DROP TABLE IF EXISTS public.wells_utm_description          CASCADE;
DROP TABLE IF EXISTS public.wells_utm_scale_codes          CASCADE;
DROP TABLE IF EXISTS public.wells_watershed_codes          CASCADE;
DROP TABLE IF EXISTS public.wells_well_licence             CASCADE;
DROP TABLE IF EXISTS public.wells_wells                    CASCADE;
DROP TABLE IF EXISTS public.wells_yield_unit_codes         CASCADE;
EOF


psql -d wells -U wells << EOF
ALTER TABLE xfer_wells.gw_aquifer_attrs SET SCHEMA public;
ALTER TABLE xfer_wells.gw_aquifer_attrs_old SET SCHEMA public;
ALTER TABLE xfer_wells.gw_aquifer_wells SET SCHEMA public;
ALTER TABLE xfer_wells.gw_casing_material_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_class_of_well_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_class_subclass_xrefs SET SCHEMA public;
ALTER TABLE xfer_wells.gw_closure_method_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_development_method_cds SET SCHEMA public;
ALTER TABLE xfer_wells.gw_drilling_method_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_filter_pack_material_cds SET SCHEMA public;
ALTER TABLE xfer_wells.gw_filter_pack_size_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_ground_elevaton_mthd_cds SET SCHEMA public;
ALTER TABLE xfer_wells.gw_liner_material_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_nts_mapsheets SET SCHEMA public;
ALTER TABLE xfer_wells.gw_orientation_of_well_cds SET SCHEMA public;
ALTER TABLE xfer_wells.gw_province_state_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_relative_hardness_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_screen_assembly_type_cds SET SCHEMA public;
ALTER TABLE xfer_wells.gw_screen_bottom_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_screen_intake_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_screen_material_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_screen_opening_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_screen_type_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_status_of_well_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_subclass_of_well_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_surface_seal_materil_cds SET SCHEMA public;
ALTER TABLE xfer_wells.gw_surface_seal_method_cds SET SCHEMA public;
ALTER TABLE xfer_wells.gw_utm_zone_codes SET SCHEMA public;
ALTER TABLE xfer_wells.gw_water_qual_chrctrstc_cds SET SCHEMA public;
ALTER TABLE xfer_wells.gw_well_water_quality_xrefs SET SCHEMA public;
ALTER TABLE xfer_wells.gw_yield_estimated_mthd_cds SET SCHEMA public;
ALTER TABLE xfer_wells.wells_acceptance_status_code SET SCHEMA public;
ALTER TABLE xfer_wells.wells_aquifer_lithology_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_aquifer_subtype_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_bcgs_numbers SET SCHEMA public;
ALTER TABLE xfer_wells.wells_casings SET SCHEMA public;
ALTER TABLE xfer_wells.wells_constant SET SCHEMA public;
ALTER TABLE xfer_wells.wells_constr_method_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_driller_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_errors SET SCHEMA public;
ALTER TABLE xfer_wells.wells_ground_water_authrzation SET SCHEMA public;
ALTER TABLE xfer_wells.wells_legal_land_dist_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_lith_description_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_lithology_colour_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_lithology_descriptions SET SCHEMA public;
ALTER TABLE xfer_wells.wells_lithology_material_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_location_accuracy_code SET SCHEMA public;
ALTER TABLE xfer_wells.wells_owners SET SCHEMA public;
ALTER TABLE xfer_wells.wells_perforations SET SCHEMA public;
ALTER TABLE xfer_wells.wells_production_data SET SCHEMA public;
ALTER TABLE xfer_wells.wells_screens SET SCHEMA public;
ALTER TABLE xfer_wells.wells_sequences SET SCHEMA public;
ALTER TABLE xfer_wells.wells_temp_access SET SCHEMA public;
ALTER TABLE xfer_wells.wells_temp_access_lithology SET SCHEMA public;
ALTER TABLE xfer_wells.wells_use_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_utm_description SET SCHEMA public;
ALTER TABLE xfer_wells.wells_utm_scale_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_watershed_codes SET SCHEMA public;
ALTER TABLE xfer_wells.wells_well_licence SET SCHEMA public;
ALTER TABLE xfer_wells.wells_wells SET SCHEMA public;
ALTER TABLE xfer_wells.wells_yield_unit_codes SET SCHEMA public;
