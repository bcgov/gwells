# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-02-23 02:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_user', models.CharField(max_length=30, null=True)),
                ('update_date', models.DateTimeField(blank=True, null=True)),
                ('casing_code_guid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('licenced_status_code', models.CharField(max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_submission', models.ForeignKey(blank=True, db_column='filing_number', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ActivitySubmission')),
                ('bedrock_material', models.ForeignKey(blank=True, db_column='bedrock_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.BedrockMaterialCode', verbose_name='Bedrock Material')),
                ('bedrock_material_descriptor', models.ForeignKey(blank=True, db_column='bedrock_material_descriptor_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.BedrockMaterialDescriptorCode', verbose_name='Descriptor')),
                ('lithology_colour', models.ForeignKey(blank=True, db_column='lithology_colour_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LithologyColourCode', verbose_name='Colour')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_user', models.CharField(max_length=30, null=True)),
                ('update_date', models.DateTimeField(blank=True, null=True)),
                ('obs_well_status_guid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('obs_well_status_code', models.CharField(max_length=10, unique=True)),
                ('description', models.CharField(max_length=255)),
                ('is_hidden', models.BooleanField(default=False)),
                ('display_order', models.PositiveIntegerField()),
                ('effective_date', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decommission_method', models.ForeignKey(blank=True, db_column='decommission_method_guid', null='True', on_delete=django.db.models.deletion.CASCADE, to='gwells.DecommissionMethodCode', verbose_name='Method of Decommission')),
                ('development_method', models.ForeignKey(blank=True, db_column='development_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.DevelopmentMethodCode', verbose_name='Developed By')),
                ...
                ('drilling_method', models.ForeignKey(blank=True, db_column='drilling_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.DrillingMethodCode', verbose_name='Drilling Method')),
                ('filter_pack_material', models.ForeignKey(blank=True, db_column='filter_pack_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.FilterPackMaterialCode', verbose_name='Filter Pack Material')),
                ('filter_pack_material_size', models.ForeignKey(blank=True, db_column='filter_pack_material_size_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.FilterPackMaterialSizeCode', verbose_name='Filter Pack Material Size')),
                ('ground_elevation_method', models.ForeignKey(blank=True, db_column='ground_elevation_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.GroundElevationMethodCode', verbose_name='Elevation Determined By')),
                ('intended_water_use', models.ForeignKey(blank=True, db_column='intended_water_use_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.IntendedWaterUseCode', verbose_name='Intended Water Use')),
                ('land_district', models.ForeignKey(blank=True, db_column='land_district_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LandDistrictCode', verbose_name='Land District')),
                ('licenced_status', models.ForeignKey(blank=True, db_column='licenced_status_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LicencedStatusCode', verbose_name='Licenced Status')),
                ('liner_material', models.ForeignKey(blank=True, db_column='liner_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LinerMaterialCode', verbose_name='Liner Material')),
                ('observation_well_status', models.ForeignKey(blank=True, db_column='obs_well_status_guid', null='True', on_delete=django.db.models.deletion.CASCADE, to='gwells.ObsWellStatusCode', verbose_name='Observation Well Status')),
                ('owner_province_state', models.ForeignKey(blank=True, db_column='province_state_guid', on_delete=django.db.models.deletion.CASCADE, to='gwells.ProvinceStateCode', verbose_name='Province')),
                ('screen_bottom', models.ForeignKey(blank=True, db_column='screen_bottom_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenBottomCode', verbose_name='Bottom')),
                ('screen_intake_method', models.ForeignKey(blank=True, db_column='screen_intake_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenIntakeMethodCode', verbose_name='Intake Method')),
                ('screen_material', models.ForeignKey(blank=True, db_column='screen_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenMaterialCode', verbose_name='Material')),
                ('screen_opening', models.ForeignKey(blank=True, db_column='screen_opening_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenOpeningCode', verbose_name='Opening')),
                ('screen_type', models.ForeignKey(blank=True, db_column='screen_type_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenTypeCode', verbose_name='Type')),
                ('surface_seal_material', models.ForeignKey(blank=True, db_column='surface_seal_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.SurfaceSealMaterialCode', verbose_name='Surface Seal Material')),
                ('surface_seal_method', models.ForeignKey(blank=True, db_column='surface_seal_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.SurfaceSealMethodCode', verbose_name='Surface Seal Installation Method')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('well_status_code', models.CharField(max_length=10, unique=True)),
                ('description', models.CharField(max_length=255)),
                ('is_hidden', models.BooleanField(default=False)),
                ('display_order', models.PositiveIntegerField()),
                ('effective_date', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('effective_date', models.DateTimeField(blank=True, null=True)),
                ('expiry_date', models.DateTimeField(blank=True, null=True)),
                ('well_class', models.ForeignKey(blank=True, db_column='well_class_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.WellClassCode')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='well',
            name='well_class',
            field=models.ForeignKey(db_column='well_class_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.WellClassCode', verbose_name='Well Class'),
        ),
        migrations.AddField(
            model_name='well',
            name='well_status',
            field=models.ForeignKey(blank=True, db_column='well_status_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.WellStatusCode', verbose_name='Well Status'),
        ),
        migrations.AddField(
            model_name='well',
            name='well_subclass',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='well_yield_unit_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.WellYieldUnitCode'),
        ),
        migrations.AddField(
            model_name='screen',
            name='assembly_type',
            field=models.ForeignKey(blank=True, db_column='screen_assembly_type_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenAssemblyTypeCode'),
        ),
        migrations.AddField(
            model_name='screen',
            name='well',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='yield_estimation_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.YieldEstimationMethodCode', verbose_name='Estimation Method'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='province_state',
            field=models.ForeignKey(db_column='province_state_guid', on_delete=django.db.models.deletion.CASCADE, to='gwells.ProvinceStateCode', verbose_name='Province'),
        ),
        migrations.AddField(
            model_name='ltsaowner',
            name='well',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='lithology_hardness_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LithologyHardnessCode', verbose_name='Hardness'),
        ),
        migrations.AddField(
            model_name='lithologydescription',
            name='lithology_material',
            field=models.ForeignKey(blank=True, db_column='lithology_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LithologyMaterialCode', verbose_name='Material'),
        ),
        migrations.AddField(
            model_name='lithologydescription',
            name='lithology_moisture',
            field=models.ForeignKey(blank=True, db_column='lithology_moisture_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LithologyMoistureCode', verbose_name='Moisture'),
        ),
        migrations.AddField(
            model_name='lithologydescription',
            name='lithology_structure',
            field=models.ForeignKey(blank=True, db_column='lithology_structure_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LithologyStructureCode', verbose_name='Bedding'),
        ),
        migrations.AddField(
            model_name='lithologydescription',
            name='secondary_surficial_material',
            field=models.ForeignKey(blank=True, db_column='secondary_surficial_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='secondary_surficial_material_set', to='gwells.SurficialMaterialCode', verbose_name='Secondary Surficial Material'),
        ),
        migrations.AddField(
            model_name='lithologydescription',
            name='surficial_material',
            field=models.ForeignKey(blank=True, db_column='surficial_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='surficial_material_set', to='gwells.SurficialMaterialCode', verbose_name='Surficial Material'),
        ),
        migrations.AddField(
            model_name='lithologydescription',
            name='water_bearing_estimated_flow_units',
            field=models.ForeignKey(blank=True, db_column='well_yield_unit_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.WellYieldUnitCode', verbose_name='Units'),
        ),
        migrations.AddField(
            model_name='lithologydescription',
            name='well_tag_number',
        ...
        migrations.AddField(
            model_name='casing',
            name='casing_code',
            field=models.ForeignKey(db_column='casing_code_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.CasingCode', verbose_name='Casing Code'),
        ),
        migrations.AddField(
            model_name='casing',
            name='casing_material',
            field=models.ForeignKey(blank=True, db_column='casing_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.CasingMaterialCode', verbose_name='Casing Material Code'),
        ),
        migrations.AddField(
            model_name='casing',
            name='well_tag_number',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='development_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.DevelopmentMethodCode', verbose_name='Development Method'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='drilling_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.DrillingMethodCode', verbose_name='Drilling Method'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='filter_pack_material',
            field=models.ForeignKey(blank=True, db_column='filter_pack_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.FilterPackMaterialCode', verbose_name='Filter Pack Material'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='filter_pack_material_size',
            field=models.ForeignKey(blank=True, db_column='filter_pack_material_size_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.FilterPackMaterialSizeCode', verbose_name='Filter Pack Material Size'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='ground_elevation_method',
            field=models.ForeignKey(blank=True, db_column='ground_elevation_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.GroundElevationMethodCode', verbose_name='Elevation Determined By'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='intended_water_use',
            field=models.ForeignKey(blank=True, db_column='intended_water_use_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.IntendedWaterUseCode', verbose_name='Intended Water Use'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='land_district',
            field=models.ForeignKey(blank=True, db_column='land_district_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LandDistrictCode', verbose_name='Land District'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='liner_material',
            field=models.ForeignKey(blank=True, db_column='liner_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LinerMaterialCode', verbose_name='Liner Material'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
        ...
        migrations.AddField(
            model_name='activitysubmission',
            name='screen_bottom',
            field=models.ForeignKey(blank=True, db_column='screen_bottom_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenBottomCode', verbose_name='Bottom'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='screen_intake_method',
            field=models.ForeignKey(blank=True, db_column='screen_intake_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenIntakeMethodCode', verbose_name='Intake'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='screen_material',
            field=models.ForeignKey(blank=True, db_column='screen_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenMaterialCode', verbose_name='Material'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='screen_opening',
            field=models.ForeignKey(blank=True, db_column='screen_opening_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenOpeningCode', verbose_name='Opening'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='screen_type',
            field=models.ForeignKey(blank=True, db_column='screen_type_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenTypeCode', verbose_name='Type'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='surface_seal_material',
            field=models.ForeignKey(blank=True, db_column='surface_seal_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.SurfaceSealMaterialCode', verbose_name='Surface Seal Material'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='surface_seal_method',
            field=models.ForeignKey(blank=True, db_column='surface_seal_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.SurfaceSealMethodCode', verbose_name='Surface Seal Installation Method'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='well_activity_type_guid', on_delete=django.db.models.deletion.CASCADE, to='gwells.WellActivityCode', verbose_name='Type of Work'),
        ),
        migrations.AddField(
            model_name='activitysubmission',
            name='well_class',
