# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2017-11-07 19:06
...
class Migration(migrations.Migration):
    ...
    replaces = [('gwells', '0001_initial'), ('gwells', '0002_auto_20171103_1935'), ('gwells', '0003_auto_20171103_1938'), ('gwells', '0004_auto_20171103_1959'), ('gwells', '0005_auto_20171103_2145'), ('gwells', '0006_auto_20171103_2225'), ('gwells', '0007_auto_20171103_2238'), ('gwells', '0008_auto_20171103_2314'), ('gwells', '0009_auto_20171103_2321'), ('gwells', '0010_auto_20171103_2325'), ('gwells', '0011_auto_20171106_1847'), ('gwells', '0012_auto_20171106_1853'), ('gwells', '0013_intakemethod_status_flag'), ('gwells', '0014_auto_20171106_1923'), ('gwells', '0015_auto_20171106_1929'), ('gwells', '0016_auto_20171106_2358'), ('gwells', '0017_auto_20171107_1610'), ('gwells', '0018_auto_20171107_1637'), ('gwells', '0019_auto_20171107_1826'), ('gwells', '0020_auto_20171107_1901')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('where_plate_attached', models.CharField(blank=True, max_length=500, verbose_name='Where Identification Plate Is Attached')),
                ...
                ('well_orientation', models.BooleanField(choices=[(True, 'vertical'), (False, 'horizontal')], default=True, verbose_name='Well Orientation')),
                ...
                ('final_casing_stick_up', models.DecimalField(blank=True, decimal_places=3, max_digits=5, null=True, verbose_name='Final Stick Up')),
                ('bedrock_depth', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='Depth to Bedrock')),
                ('static_water_level', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='Static Water Level')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drive_shoe', models.BooleanField(choices=[(False, 'No'), (True, 'Yes')], default=False, verbose_name='Drive Shoe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('who_updated', models.CharField(max_length=30, null=True)),
                ('when_updated', models.DateTimeField(blank=True, null=True)),
                ('well_licenced_status_guid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('code', models.CharField(max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lithology_from', models.DecimalField(decimal_places=2, max_digits=7, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))], verbose_name='From')),
                ('lithology_to', models.DecimalField(decimal_places=2, max_digits=7, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))], verbose_name='To')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('well_identification_plate_attached', models.CharField(blank=True, max_length=500, null=True, verbose_name='Where Identification Plate Is Attached')),
                ('latitude', models.DecimalField(blank=True, decimal_places=6, max_digits=8, null=True)),
                ('longitude', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True)),
                ('ground_elevation', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Ground Elevation')),
                ('other_drilling_method', models.CharField(blank=True, max_length=50, verbose_name='Specify Other Drilling Method')),
                ...
                ('total_depth_drilled', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='Total Depth Drilled')),
                ('finished_well_depth', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='Finished Well Depth')),
                ('final_casing_stick_up', models.DecimalField(blank=True, decimal_places=3, max_digits=6, null=True, verbose_name='Final Stick Up')),
                ('bedrock_depth', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True, verbose_name='Depth to Bedrock')),
                ...
                ('well_cap_type', models.CharField(blank=True, max_length=40, verbose_name='Well Cap')),
                ('well_disinfected', models.BooleanField(choices=[(False, 'No'), (True, 'Yes')], default=False, verbose_name='Well Disinfected?')),
                ('comments', models.CharField(blank=True, max_length=3000)),
                ('alternative_specs_submitted', models.BooleanField(default=False, verbose_name='Alternative specs submitted (if required)')),
                ('diameter', models.CharField(blank=True, max_length=9)),
                ('observation_well_number', models.PositiveIntegerField(blank=True, null=True)),
                ('observation_well_status', models.CharField(blank=True, max_length=25, null=True)),
                ('ems', models.CharField(blank=True, max_length=10, null=True)),
                ('development_method', models.ForeignKey(blank=True, db_column='development_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.DevelopmentMethod', verbose_name='Development Method')),
                ...
                ('ground_elevation_method', models.ForeignKey(blank=True, db_column='ground_elevation_method_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.GroundElevationMethod', verbose_name='Method for Determining Ground Elevation')),
                ...
                ('licenced_status_guid', models.ForeignKey(blank=True, db_column='licenced_status_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.LicencedStatus', verbose_name='Licenced Status')),
                ...
                ('screen_bottom', models.ForeignKey(blank=True, db_column='screen_bottom_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenBottom', verbose_name='Screen Bottom')),
                ('screen_intake', models.ForeignKey(blank=True, db_column='screen_intake_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenIntake', verbose_name='Intake')),
                ('screen_material', models.ForeignKey(blank=True, db_column='screen_material_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenMaterial', verbose_name='Screen Material')),
                ('screen_opening', models.ForeignKey(blank=True, db_column='screen_opening_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenOpening', verbose_name='Screen Opening')),
                ('screen_type', models.ForeignKey(blank=True, db_column='screen_type_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ScreenType', verbose_name='Screen Type')),
