...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('registries', '0007_auto_20180613_2231'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(db_column='registries_proof_of_age_code',
        ...
        migrations.AlterField(
            ...
            field=models.CharField(db_column='registries_application_status_code',
                                   editable=False, max_length=10, primary_key=True, serialize=False),
        ),
        migrations.AlterField(
            model_name='registriesremovalreason',
            name='registries_removal_reason_code',
            field=models.CharField(db_column='registries_removal_reason_code',
                                   editable=False, max_length=10, primary_key=True, serialize=False),
        ),
