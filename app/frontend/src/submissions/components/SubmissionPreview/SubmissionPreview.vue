<template>
  <div>
    <h2>Well Submission Preview</h2>
    <div class="my-3">
      <h3>Type of Work and Well Class</h3>
      <b-row>
        <b-col>
    ...
    <div class="my-3">
      <h3>Surface Seal and Backfill Details</h3>
      <b-row>
