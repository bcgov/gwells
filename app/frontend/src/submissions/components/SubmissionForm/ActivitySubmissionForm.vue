...
<template>
  <div>
    ...
    <well-type class="my-5"
      ...
      v-model:endDateOfWorkLabel="this.endDateOfWorkLabel"
      v-model:wellIdentificationPlateNumberLabel="this.wellIdentificationPlateNumberLabel"
      v-model:wellIdentificationPlateAttachedLabel="this.wellIdentificationPlateAttachedLabel"
      v-model:wellTagNumber="form.well"
      v-model:wellStatusCode="form.well_status"
      v-model:wellActivityType="activityType"
      v-model:wellClass="form.well_class"
      v-model:wellSubclass="form.well_subclass"
      v-model:intendedWaterUse="form.intended_water_use"
      v-model:units="units"
      v-model:idPlateNumber="form.identification_plate_number"
      v-model:wellPlateAttached="form.well_identification_plate_attached"
      v-model:idPlateAttachedBy="form.id_plate_attached_by"
      v-model:waterSupplySystem="form.water_supply_system_name"
      v-model:waterSupplyWell="form.water_supply_system_well_name"
