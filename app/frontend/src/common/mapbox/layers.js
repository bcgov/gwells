...
export function wellsBaseAndArtesianLayer (options = {}) {
  ...
  const styles = defaultsDeep(options.styles, {
    ...
    'circle-stroke-color': [
      'case',
      ['boolean', ['get', 'has_hydraulic_info']], '#04E762',
...
export function searchedWellsLayer (options = {}) {
  ...
  const styles = defaultsDeep(options.styles, {
    ...
    'circle-stroke-color': [
      'case',
      ['to-boolean', ['get', 'storativity']], '#04E762',
      ['to-boolean', ['get', 'transmissivity']], '#04E762',
      ['to-boolean', ['get', 'hydraulic_conductivity']], '#04E762',
