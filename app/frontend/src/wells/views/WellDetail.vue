      ...
      <b-card v-else class="container p-1">
        ...
        <fieldset id="well_completion_data_fieldset" class="my-3 detail-section">
          ...
          <b-row>
            ...
            <b-col cols="12" md="4"><span class="font-weight-bold">Artesian Pressure (head):</span> {{ well.artesian_pressure | excludeZeroDecimals }} {{ well.artesian_pressure ? 'feet': ''}}</b-col>
          </b-row>
          <b-row>
            ...
            <b-col cols="12" md="4"><span class="font-weight-bold">Artesian Pressure (PSI):</span> {{ well.artesian_pressure | excludeZeroDecimals }} {{ well.artesian_pressure ? 'feet': ''}}</b-col>
          </b-row>
          <b-row>
