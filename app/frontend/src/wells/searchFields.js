...
const searchFields = {
  ...
  optional: [
    ...
    },
    {
      ...
      fields: [
        {
          id: 'waterQualityCharacteristics',
    ...
    },
    {
      ...
      fields: [
        ...
        {
          id: 'decommissionSealantMaterial',
          param: 'decommission_sealant_material',
          label: 'Sealant material',
          type: 'text'
        },
        {
          id: 'decommissionBackfillMaterial',
