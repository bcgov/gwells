...
def post_migration_callback(sender, **kwargs):
    ...
    logger.info('Running post_migration_callback for registries')
    db_actions.create_db_comments_from_models(db_actions.get_all_model_classes('registries.models'))
