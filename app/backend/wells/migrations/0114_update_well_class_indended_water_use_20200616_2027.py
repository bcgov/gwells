...
UPDATE_WELLS = """
    ...
    WHERE
        intended_water_use_code IN ('DOM', 'COM', 'DWS', 'IRR', 'OP_LP_GEO');
"""

UPDATE_SUBMISSIONS = """
    UPDATE activity_submission SET well_class_code = 'UNK' WHERE well_class_code IS NULL;
    UPDATE activity_submission SET intended_water_use_code = 'NA' WHERE intended_water_use_code IS NULL;
