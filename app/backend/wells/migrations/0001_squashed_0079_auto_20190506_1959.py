# Generated by Django 2.2.1 on 2019-05-09 23:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=255, verbose_name='Licenced Status')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decommission_details', models.CharField(blank=True, max_length=250, null=True, verbose_name='Decommission Details')),
                ('ems_id', models.CharField(blank=True, max_length=30, null=True)),
                ('driller_name', models.CharField(blank=True, max_length=200, null=True, verbose_name='Name of Person Who Did the Work')),
                ('consultant_name', models.CharField(blank=True, max_length=200, null=True, verbose_name='Consultant Name')),
                ('consultant_company', models.CharField(blank=True, max_length=200, null=True, verbose_name='Consultant Company')),
                ('aquifer_vulnerability_index', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True, verbose_name='AVI')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('well_tag_number', models.ForeignKey(blank=True, db_column='well_tag_number', null=True, on_delete=django.db.models.deletion.CASCADE, to='wells.Well')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('well', models.ForeignKey(blank=True, db_column='well_tag_number', null=True, on_delete=django.db.models.deletion.CASCADE, to='wells.Well')),
            ],
            options={
                'db_table': 'ltsa_owner',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('well_tag_number', models.ForeignKey(db_column='well_tag_number', on_delete=django.db.models.deletion.CASCADE, to='wells.Well')),
            ],
            options={
