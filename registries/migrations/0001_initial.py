# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-04-05 17:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AccreditedCertficateCode',
            fields=[
                ('create_user', models.CharField(max_length=30)),
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('update_user', models.CharField(max_length=30, null=True)),
                ('update_date', models.DateTimeField(blank=True, null=True)),
                ('acc_cert_guid', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='Accredited Certficate UUID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_certificate', models.ForeignKey(blank=True, db_column='acc_cert_guid', null=True, on_delete=django.db.models.deletion.PROTECT, to='registries.AccreditedCertficateCode', verbose_name='Certificate')),
        ...
        migrations.AddField(
            model_name='accreditedcertficatecode',
            name='cert_auth',
