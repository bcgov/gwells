    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province_state', models.ForeignKey(db_column='province_state_guid', null=True, on_delete=django.db.models.deletion.CASCADE, to='gwells.ProvinceState', verbose_name='Province/State')),
            ],
            options={
